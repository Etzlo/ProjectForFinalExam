...
// Проблема в этом коде заключается в том, что document.querySelectorAll возвращает коллекцию, а не отдельный элемент. У коллекции нет метода addEventListener. Поэтому, чтобы добавить обработчик событий ко всем элементам коллекции, нужно использовать цикл forEach, как написано в выше.
